((h, c, d, O) => {
    ...
    function At(e) {
        ...
        t.element.classList.add("selected"), tt.querySelector(".size-preview .icon").style.backgroundSize = Mt(Ct) + "%", yt()
    }
    ...
    function Tt(e, t) {
        It(lt[e].element), e == vt && !t || (lt[vt].element.classList.remove("selected"), lt[e].element.classList.add("selected"), vt = e, yt())
    }

    function Nt(e) {
        var t = zt(kt[e]);
        bt = e, c.querySelector("#color-preview-primary").style.fill = t, c.querySelector("#game-toolbar .color-preview-mobile").style.backgroundColor = t, yt()
    }
    ...
    function Qt(e) {
        if (L.id == j && M == x && -1 != qt) {
            ...
            vt == Xe && (e = Ct, 0 <= gt && (e = (e - Je) * q(gt, 0, 1) + Je), l = Math.ceil(.5 * e), s = q(Math.floor(mt[0]), -l, C.width + l), o = q(Math.floor(mt[1]), -l, C.height + l), r = q(Math.floor(b[0]), -l, C.width + l), i = q(Math.floor(b[1]), -l, C.height + l), t = t, e = e, a = s, o = o, r = r, i = i, n = [je, t, e, a, o, r, i]), null != n && Vt(n)
        }
        var a, o, r, i, l, s
    }
    ...
    var S, ln = 0,
        ...
        cn = (setInterval(function() {
            ...
            S && L.id == j && M == x && 0 < (e = v.length - dt) && (t = dt + 8, n = v.slice(dt, t), S.emit("data", {
                id: Ia,
                data: n
            }), dt = Math.min(t, v.length), console.log(`Sent ${n.length} commands. ${e} remaining.`))
                ...
                if (0 < e.data.length) {
                    ...
                    for (var h = 0; h < 3; h++) {
                        ...
                        if (0 < p.length) {
                            ...
                            for (o = 0; o < p.length; o++) pe(b = de((s = p[o]).player.avatar, 0 == h), Ya(s.player)), b.style.left = 15 * -(p.length - 1) + 30 * o + "%", 0 == h && (b.classList.add("winner"), b.style.animationDelay = -2.35 * o + "s"), l.appendChild(b)
                        }
                    }
                    for (var v = Math.min(5, u[3].length), o = 0; o < v; o++) {
                        var b, s = u[3][o],
                            f = $("rank");
                        pe(b = de(s.player.avatar, !1), Ya(s.player)), f.appendChild(b), f.appendChild($("rank-place", "#" + (s.rank + 1))), f.appendChild($("rank-name", s.player.name)), f.appendChild($("rank-score", E("$ points", s.player.score))), d[3].appendChild(f)
                    }
            ...
            case V:
                if (e.data.words)
                    ...
                    var L = (s = W(e.data.id)) ? s.name : E("User"),
                        L = (A.textContent = "", A.appendChild(se("span", void 0, E("$ is choosing a word!", L))), de(s ? s.avatar : [0, 0, 0, 0], e.data.id == En));
    ...
    function sa(e, t) {
        ...
        if (e.id == j) {
            if (M = e.data.id, R.playSound(Sn), Kt(!0), e.data.drawCommands && (v = e.data.drawCommands), y(E("$ is drawing now!", W(M).name), "", f(De), !0), !t)
    ...
    function Pa(e) {
        ...
        switch (t) {
            ...
            case Wa:
                ...
                break;
            case Ia:
                for (var s = 0; s < n.length; s++) Vt(n[s]);
                break;
            case Ra:
                Kt(!0);
                break;
    ...
    c.querySelector("#audio"), c.querySelector("#lightbulb"), D(n, "click", function() {
        ...
        var t, e, n, a, o;
        n = h.location.href, o = "", n = n.split("?"), t = o = 1 < n.length ? (o = "" + n[1]).substring(0, a) : o, Nn || (e = "" != t ? "id=" + t : "lang=" + Fn.value, xe(), Jn(!0), ta(function() {
            Qn($n, e, function(e) {
        ...
        var e = window.location.href.split("?")[0] + "?" + Tn;
